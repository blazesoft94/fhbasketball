	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="../../index.php"><?php _e('Fhbasketball | Recruit'); ?></a>
	    </div>
		...
		<?php } else { ?>
		<ul class="nav navbar-nav navbar-right">
			<li><a href="../login.php" class="signup-link"><em></em> <strong><?php _e('Sign Up | Sign In'); ?></strong></a></li>
		</ul>
		<?php } ?>
   </div><!-- /.navbar-collapse -->
  </div><!-- /.container -->
