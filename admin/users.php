                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <?php 
                                        //Display Posts
                                        $sql = "SELECT * from users ORDER BY user_id__blazeweb desc";
                                        $result = $con->query($sql);
                                        $count = 0;
                                        if($result->num_rows>0){
                                            while($row = $result->fetch_assoc()){
                                                $count++;
                                                $u_id = $row['user_id__blazeweb'];
                                                $u_username = $row['user_username__blazeweb'];
                                                $u_email = $row["user_email__blazeweb"];
                                                $u_firstname = $row['user_firstname__blazeweb'];
